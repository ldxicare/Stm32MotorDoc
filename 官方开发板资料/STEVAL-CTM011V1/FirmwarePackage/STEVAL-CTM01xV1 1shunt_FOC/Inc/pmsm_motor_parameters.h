...
#define RS                     7.50 /* Stator resistance , ohm*/
#define LS                     0.042000 /* Stator inductance, H
...
#define NOMINAL_CURRENT         32758
#define MOTOR_MAX_SPEED_RPM     4500 /*!< Maximum rated speed  */
#define MOTOR_VOLTAGE_CONSTANT  25.3 /*!< Volts RMS ph-ph /kRPM */
#define ID_DEMAG                -32758 /*!< Demagnetization current */
